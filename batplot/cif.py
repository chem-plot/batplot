    ...
    with open(fname, 'r', encoding='utf-8', errors='ignore') as f:
        for raw in f:
            ...
            if in_atom_loop and not line.startswith('_'):
                ...
                ix = gidx('_atom_site_fract_x')
                iy = gidx('_atom_site_fract_y')
                iz = gidx('_atom_site_fract_z')
                isym = gidx('_atom_site_type_symbol')
                ilab = gidx('_atom_site_label')
                iocc = gidx('_atom_site_occupancy')
